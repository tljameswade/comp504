...
public class ChatRoomGUI<TList> extends JFrame {
	...
	/**
	 * The chatroom GUI constructor
	 * @param modelAdpt the view to model adapter
	 */
	...
	/**
	 * The start method
	 * @param chatServerProxys a hashset of the chatserver proxy
	 */
